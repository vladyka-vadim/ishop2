...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 19 2022 г., 16:00
...
(6, 5, '1', '2022-07-14 10:26:51', '2022-09-14 06:40:30', 'USD', 'спасибо');
...
(10, 6, 1, 1, 'Casio MRP-700-1AVEF', 300);
...
(11, 6, 2, 'Тестовый товар', 'testovyy-tovar', 'контент...', 10, 0, '1', NULL, NULL, 'no_image.jpg', '0'),
...
(37, 14, 0, 'test1', 'test1', '', 500, 0, '1', '', '', 'no_image.jpg', '0'),
(38, 14, 0, 'test2', 'test2', '', 500, 0, '1', '', '', 'no_image.jpg', '0'),
(39, 14, 0, 'test2', 'test2-39', '', 500, 0, '1', '', '', 'no_image.jpg', '0'),
(40, 14, 0, 'test2', 'test2-40', '', 500, 0, '1', '', '', 'no_image.jpg', '0'),
(41, 14, 0, 'test2', 'test2-41', '', 500, 0, '1', '', '', 'no_image.jpg', '0');
...
(2, 'test1', '$2y$10$OYoN5VKJXy6HGe.fin6HlOlvSK/y/MhUnXAerJhGZGQmRZ9mLAUCi', 'test1@mail.ru', 'test1', 'test1@mail.ru', 'user'),
(3, 'test2', '$2y$10$9npKKsxtdxnY51mARypm5uIhzs5qCo3ShipADe/cx6L8dmjXfrtgG', 'test2@mail.ru', 'test2', 'test2', 'user'),
(4, 'test3', '$2y$10$zqZO3AsG/6AKhbQA/T.ene6tWQKO5fnqa/M33MgXBBF/4XiTRMyGC', 'test3@mail.ru', 'test3', 'test3', 'user'),
(5, 'admin', '$2y$10$5CR1MpPxek9cs.SDL8xnG.U7aYwQlhqANqo93OXY6HUkkpNdFgdwi', 'admin@mail.ru', 'admin', 'admin', 'admin');
